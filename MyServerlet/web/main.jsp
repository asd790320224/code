...
<div class="container">
  <form action="search.jsp" method="post" accept-charset="UTF-8">
    <input height="150px" type="text" id="search-form" name="search" />
...
<div class="product-list">
  ...
  try {
    ...
    // 执行 SQL 查询，获取所有商品信息
    ResultSet rs = stmt.executeQuery("SELECT * FROM 商品信息");
    // 遍历结果集，输出每个商品的信息
    while (rs.next()) {
      ...
      if (thumbnailData != null) {
        ...
        out.println("        <img src='data:image/jpeg;base64," +
                    Base64.getEncoder().encodeToString(thumbnailData) +
                    "' alt='缩略图' width='190' height='190'>");
        out.println("      </td>");
      }
      out.println("      <td>");
